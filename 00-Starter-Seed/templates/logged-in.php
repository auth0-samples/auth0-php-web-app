        ...
        <div class="shadow sm:rounded-md sm:overflow-hidden">
          <div class="bg-white">
            <div class="px-4 py-5 sm:px-6 bg-gray-100">
              ...
              <p class="mt-1 text-sm text-gray-500">Retrieve these using <span class="font-mono text-xs">Auth0::getCredentials()</span>, or <span class="font-mono text-xs">Auth0::getIdToken()</span>, <span class="font-mono text-xs">Auth0::getAccessToken()</span>, <span class="font-mono text-xs">Auth0::getAccessTokenExpiration()</span>, and <span class="font-mono text-xs">Auth0::getRefreshToken()</span> respectively.</p>
            </div>
      ...
      <div class="login-page clearfix">
        <?php if($session === null): ?>
          <div class="login-box auth0-box before">
            ...
            <a id="qsLoginBtn" class="btn btn-primary btn-lg btn-login btn-block" href="<?php echo($loginUri) ?>">Sign In</a>
          </div>
        <?php else: ?>
            <div class="logged-in-box auth0-box logged-in" id="profileDropDown">
              ...
              <h2>
                <img class="avatar" src="<?php echo $session->user['picture'] ?>"/>
                <span>Welcome <span class="nickname"><?php echo $session->user['nickname'] ?></span></span>
              </h2>

              <textarea>
                <?php htmlspecialchars(print_r($session->user)); ?>
              </textarea>

              <a id="qsLogoutBtn" class="btn btn-warning btn-logout" href="<?php echo($logoutUri) ?>">Logout</a>
          </div>
        <?php endif ?>
      </div>
    </div>
